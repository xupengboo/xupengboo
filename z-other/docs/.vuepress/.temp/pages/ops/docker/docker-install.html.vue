<template><div><h2 id="一、docker-简介" tabindex="-1"><a class="header-anchor" href="#一、docker-简介"><span>一、Docker 简介</span></a></h2>
...
<h2 id="二、docker-的架构" tabindex="-1"><a class="header-anchor" href="#二、docker-的架构"><span>二、Docker 的架构</span></a></h2>
...
<h2 id="三、docker准备" tabindex="-1"><a class="header-anchor" href="#三、docker准备"><span>三、Docker准备</span></a></h2>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h2 id="四、安装docker" tabindex="-1"><a class="header-anchor" href="#四、安装docker"><span><strong>四、安装Docker</strong></span></a></h2>
<p>1、更新 Yum 包的索引</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="五、卸载-docker" tabindex="-1"><a class="header-anchor" href="#五、卸载-docker"><span>五、卸载 Docker</span></a></h2>
<p>1、卸载 Docker 软件包</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h2 id="六、配置镜像加速器" tabindex="-1"><a class="header-anchor" href="#六、配置镜像加速器"><span>六、配置镜像加速器</span></a></h2>
...
<h2 id="七、ipv4转向配置" tabindex="-1"><a class="header-anchor" href="#七、ipv4转向配置"><span>七、ipv4转向配置</span></a></h2>
