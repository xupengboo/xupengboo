(function (exports, shared, vue) {
  ...
  function createTemplatePromise(options = {}) {
    ...
    const component = /* #__PURE__ */ vue.defineComponent((_, { slots }) => {
      const renderList = () => instances.value.map((props) => {
        var _a;
        return vue.h(vue.Fragment, { key: props.key }, (_a = slots.default) == null ? undefined : _a.call(slots, props));
      });
  ...
  const defaultLocation = shared.isClient ? window.location : undefined;
  ...
  function useAnimate(target, keyframes, options) {
    ...
    const animate = vue.shallowRef(undefined);
  ...
  function useBreakpoints(breakpoints, options = {}) {
    ...
    const mounted = ssrSupport ? vue.ref(false) : { value: true };
    if (ssrSupport) {
  ...
  function useCycleList(list, options) {
    ...
    function getInitialValue() {
      var _a, _b;
      return (_b = vue.toValue((_a = options == null ? undefined : options.initialValue) != null ? _a : vue.toValue(list)[0])) != null ? _b : undefined;
    }
  ...
  function useDebouncedRefHistory(source, options = {}) {
    const filter = options.debounce ? shared.debounceFilter(options.debounce) : undefined;
  ...
  function useElementByPoint(options) {
    ...
    const cb = () => {
      var _a, _b;
      element.value = vue.toValue(multiple) ? (_a = document == null ? undefined : document.elementsFromPoint(vue.toValue(x), vue.toValue(y))) != null ? _a : [] : (_b = document == null ? undefined : document.elementFromPoint(vue.toValue(x), vue.toValue(y))) != null ? _b : null;
    };
        ...
        get(target2, prop, rec) {
          ...
          if (!(prop in refs)) {
            if (/[+_-]/.test(prop)) {
              ...
              refs[prop] = vue.computed(() => keys.every((key) => vue.toValue(proxy[key])));
            } else {
  ...
  function useNavigatorLanguage(options = {}) {
    ...
    const language = vue.ref(navigator == null ? undefined : navigator.language);
  ...
  function useNetwork(options = {}) {
    ...
    const offlineAt = vue.ref(undefined);
    const onlineAt = vue.ref(undefined);
    const downlink = vue.ref(undefined);
    const downlinkMax = vue.ref(undefined);
    const rtt = vue.ref(undefined);
    const effectiveType = vue.ref(undefined);
  ...
  function useTextareaAutosize(options) {
    var _a, _b;
    const textarea = shared.toRef(options == null ? undefined : options.element);
    const input = shared.toRef((_a = options == null ? undefined : options.input) != null ? _a : "");
    ...
    function triggerResize() {
      ...
      const _styleTarget = vue.toValue(options == null ? undefined : options.styleTarget);
      if (_styleTarget)
  ...
  function useTitle(newTitle = null, options = {}) {
    ...
    const title = shared.toRef((_b = newTitle != null ? newTitle : document == null ? undefined : document.title) != null ? _b : null);
