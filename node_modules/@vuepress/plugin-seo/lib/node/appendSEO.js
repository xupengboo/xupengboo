...
export const appendSEO = (app, { author, canonical, fallBackImage = '', hostname, isArticle = (articlePage) => Boolean(articlePage.filePathRelative && !articlePage.frontmatter.home), customHead, ogp, jsonLd, ...rest }) => {
