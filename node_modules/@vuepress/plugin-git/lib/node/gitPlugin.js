...
export const gitPlugin = ({ createdTime, updatedTime, contributors, changelog = false, filter, 
// eslint-disable-next-line @typescript-eslint/no-deprecated
transformContributors, } = {}) => (app) => {
    ...
    return {
        ...
        extendsPage: async (page) => {
            ...
            if (!(frontmatter.contributors ?? contributors ?? true) &&
            ...
            if (frontmatter.changelog ?? changelog) {
                ...
                page.data.git.changelog = resolveChangelog(app, commits, changelogOptions, gitProvider, contributorsOptions.info ?? []);
            }
        },
